...
| [What is covered](https://github.com/gberikov/Wapper/blob/master/docs/coverage.md) | Every endpoint and webhook field this library types, and the ones it does not. |
| [Performance](https://github.com/gberikov/Wapper/blob/master/docs/performance.md) | What parsing, pacing and uploading cost, measured, and how to measure them again. |
